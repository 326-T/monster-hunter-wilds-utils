...
const resources = {
	ja: {
		translation: {
			...
			"verify.sections.desired": "欲しいスキル",
			...
			"verify.desired.description":
				"武器・属性ごとに欲しいスキルを登録します。片方だけでもOKです。",
			"verify.desired.table": "武器・属性",
			"verify.desired.series": "シリーズスキル",
			"verify.desired.group": "グループスキル",
			"verify.desired.any": "指定なし",
			"verify.desired.allAttributes": "全属性で登録",
			"verify.desired.note":
				"進めるで選択した結果と一致すると入手済みに自動更新されます。",
			"verify.desired.add": "欲しいスキルを追加",
			"verify.desired.empty": "まだ登録されていません",
			"verify.desired.acquired": "入手済み",
			"verify.desired.pending": "未入手",
			"verify.desired.status": "状態",
			"verify.desired.actions": "操作",
			"verify.desired.remove": "削除",
			"verify.desired.autoFavorite": "欲しいスキルを一括お気に入り",
			"verify.desired.autoFavoriteNote":
				"未入手かつ未通過の一致結果をお気に入りにします。",
			"verify.bulk.note": "条件を指定して一括でお気に入りにできます。",
			"verify.bulk.open": "一括お気に入り",
			"verify.bulk.title": "一括お気に入り",
			"verify.bulk.description":
				"武器種は必須、シリーズ/グループは任意で指定できます。",
			"verify.bulk.weapon": "武器種",
			"verify.bulk.series": "シリーズスキル",
			"verify.bulk.group": "グループスキル",
			"verify.bulk.cancel": "キャンセル",
			"verify.bulk.apply": "一括でお気に入り",
			"filter.weapon": "武器",
			"filter.attribute": "属性",
	...
	en: {
		translation: {
			...
			"verify.sections.desired": "Desired Skills",
			...
			"verify.desired.description":
				"Register desired skills by weapon and attribute. You can set either one.",
			"verify.desired.table": "Weapon / Attribute",
			"verify.desired.series": "Series skill",
			"verify.desired.group": "Group skill",
			"verify.desired.any": "Any",
			"verify.desired.allAttributes": "Register for all attributes",
			"verify.desired.note":
				"Matches are auto-marked as acquired when you advance the cursor.",
			"verify.desired.add": "Add desired skill",
			"verify.desired.empty": "No desired skills yet",
			"verify.desired.acquired": "Acquired",
			"verify.desired.pending": "Pending",
			"verify.desired.status": "Status",
			"verify.desired.actions": "Actions",
			"verify.desired.remove": "Remove",
			"verify.desired.autoFavorite": "Auto-favorite desired skills",
			"verify.desired.autoFavoriteNote":
				"Favorites pending matches that haven't been passed yet.",
			"verify.bulk.note": "Bulk mark favorites by condition.",
			"verify.bulk.open": "Bulk favorite",
			"verify.bulk.title": "Bulk favorite",
			"verify.bulk.description":
				"Weapon is required; series/group filters are optional.",
			"verify.bulk.weapon": "Weapon",
			"verify.bulk.series": "Series skill",
			"verify.bulk.group": "Group skill",
			"verify.bulk.cancel": "Cancel",
			"verify.bulk.apply": "Apply favorites",
