...
const resources = {
  ja: {
    translation: {
      ...
      'save.ocr.description': 'ゲーム画面を読み取ってシリーズ/グループを自動登録します。',
      ...
      'save.ocr.idle': 'カメラを起動して範囲を指定します。',
      ...
      'save.ocr.previewPlaceholder': 'カメラを起動するとプレビューが表示されます。',
      ...
      'tour.verify.export': 'エクスポート/インポートでデータを保存・復元します。',
      'tour.verify.filters': '武器/属性で確認対象を絞り込みます。',
      'tour.verify.table': 'カーソルごとに結果が並び、セルを押すとお気に入りを切り替えます。',
    },
  },
  en: {
    translation: {
      ...
      'save.ocr.description': 'Read the game screen and auto-register series/group skills.',
      ...
      'save.ocr.idle': 'Start the camera and set a capture area.',
      ...
      'tour.cursor.candidates': 'Candidates available for the current cursor appear here.',
      ...
      'tour.verify.table': 'Rows are grouped by cursor. Click a cell to toggle favorite.',
    },
  },
}
